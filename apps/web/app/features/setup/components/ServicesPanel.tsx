        ...
        <div className="w-full h-full p-8 flex flex-col justify-center gap-4">
            ...
            <div className="space-y-1 px-3">
                <div className="flex items-center justify-between py-1.5">
                    <span className="text-sm text-gray-700 dark:text-gray-300">{t('setup.services.backgroundJobs')}</span>
                    <div className={`w-2 h-2 rounded-full ${status?.backgroundJobsService ? 'bg-green-500' : 'bg-gray-400'}`} />
                </div>

                <div className="flex items-center justify-between py-1.5">
                    <span className="text-sm text-gray-700 dark:text-gray-300">{t('setup.services.mlService')}</span>
