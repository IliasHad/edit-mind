...
// Changing this model requires rebuilding/reindexing existing text vectors.
export const TEXT_EMBEDDING_MODEL = 'Xenova/paraphrase-multilingual-mpnet-base-v2';

export const EMBEDDING_TIMEOUT = 60000
export const MODEL_DIMENSIONS = {
  text: 768, // paraphrase-multilingual-mpnet-base-v2
